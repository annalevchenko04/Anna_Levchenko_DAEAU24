CREATE SCHEMA IF NOT EXISTS sa_v_sales_data_1;

CREATE SCHEMA IF NOT EXISTS sa_v_sales_data_2;
...
DROP FOREIGN TABLE IF EXISTS sa_v_sales_data_1.ext_sales;

CREATE FOREIGN TABLE sa_v_sales_data_1.ext_sales (
    vin VARCHAR(1000),
    city VARCHAR(1000),
    state VARCHAR(1000),
...
DROP TABLE IF EXISTS  sa_v_sales_data_1.src_sales;

CREATE TABLE IF NOT EXISTS sa_v_sales_data_1.src_sales (
    vin VARCHAR(1000),
    city VARCHAR(1000),
    state VARCHAR(1000),
    postal_code VARCHAR(1000),
...
INSERT INTO sa_v_sales_data_1.src_sales
SELECT DISTINCT 
    vin::VARCHAR(1000),
    city::VARCHAR(1000),
    state::VARCHAR(1000),
    ...
    channel_type::VARCHAR(1000),
    channel_description::VARCHAR(1000)
FROM sa_v_sales_data_1.ext_sales;

DROP FOREIGN TABLE IF EXISTS sa_v_sales_data_2.ext_sales;

CREATE FOREIGN TABLE sa_v_sales_data_2.ext_sales (
	vin VARCHAR(1000),
    city VARCHAR(1000),
    state VARCHAR(1000),
    postal_code VARCHAR(1000),
...
DROP TABLE IF EXISTS  sa_v_sales_data_2.src_sales;

CREATE TABLE IF NOT EXISTS sa_v_sales_data_2.src_sales (
    vin VARCHAR(1000),
    city VARCHAR(1000),
    state VARCHAR(1000),
    postal_code VARCHAR(1000),
...
INSERT INTO sa_v_sales_data_2.src_sales
SELECT DISTINCT 
    vin::VARCHAR(1000),
    city::VARCHAR(1000),
    state::VARCHAR(1000),
    ...
    employee_name::VARCHAR(1000),
    employee_email::VARCHAR(1000)
FROM sa_v_sales_data_2.ext_sales;